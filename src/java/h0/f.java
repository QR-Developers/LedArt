...
implements View.OnClickListener {
    ...
    public /* synthetic */ f(CloudResourcePreviewActivity cloudResourcePreviewActivity) {
        this.a = cloudResourcePreviewActivity;
    }

    public final void onClick(View view) {
        CloudResourcePreviewActivity.V1((CloudResourcePreviewActivity)this.a, (View)view);
    }
}
